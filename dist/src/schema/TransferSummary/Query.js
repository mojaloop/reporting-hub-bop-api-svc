...
const TransferSummaryFilter = (0, nexus_1.inputObjectType)({
...
const Query = (0, nexus_1.extendType)({
    ...
    definition(t) {
        t.nonNull.list.nonNull.field('transferSummary', {
            ...
            args: {
                filter: (0, nexus_1.arg)({ type: 'TransferSummaryFilter' }),
                limit: (0, nexus_1.intArg)(),
                offset: (0, nexus_1.intArg)(),
            },
            resolve: async (parent, args, ctx, info) => {
                const fields = ctx.getRequestFields(info);
...
exports.default = [Query, TransferSummaryFilter];
